// login file for place the requisition
...
var login = React.createClass({
  ...
  handleClick(event) {
    ...
    alert(" You are Sucessfully Logged In to Create Requisition!")

    //ReactDOM.render(<User_Requisition/>,document.getElementById('root'))
    window.location.assign('/userRequisition?_empId='+empId);

  }
    else{
     alert("We could not find your details in RBS users with access to Create Requisitions!")
